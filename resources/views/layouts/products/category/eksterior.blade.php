...
<section 
  ...
  style="background-image: url('{{ asset('img/eksterior/bg6.png') }}');">
  ...
  Temukan Cat 
  <span class="text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-red-500 to-red-600 font-extrabold">
    Eksterior
  </span> 
...
<section
  ...
  style="background-image: url('{{ asset('img/eksterior/bg5.png') }}');">
