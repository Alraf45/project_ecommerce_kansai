...
<section 
  ...
  style="background-image: url('{{ asset('img/interior/bg5.png') }}');">
  ...
  Temukan Cat 
  <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 font-extrabold">
    Interior
  </span> 
...
<section
  ...
  style="background-image: url('{{ asset('img/interior/bg2.png') }}');">
