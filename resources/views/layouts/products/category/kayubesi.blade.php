...
<section class="relative h-[90vh] bg-gradient-to-br from-gray-400 via-gray-600 to-gray-800 flex flex-col items-center justify-center text-center text-white overflow-hidden">
  ...
  <div class="relative z-10 max-w-3xl mx-auto px-6">
    <h1 class="text-5xl md:text-6xl font-extrabold mb-6 leading-tight drop-shadow-lg animate-fade-in-up">
      Temukan Cat Kayu & Besi Kami untuk Setiap Kebutuhan Anda
    </h1>
