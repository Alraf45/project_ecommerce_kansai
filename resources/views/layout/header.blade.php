...
<body class="bg-white font-sans text-gray-700">
  ...
  <nav class="w-full flex flex-wrap items-center justify-between px-8 py-2 shadow-sm sticky top-0 bg-white z-50">
    ...
    <a href="/" class="flex items-center space-x-1 px-5">
     ...
     <!-- Menu -->
    <ul class="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm font-medium mt-3 md:mt-0">
      <li>
        <a href="/" class="nav-link relative font-semibold block py-2 px-2 text-gray-700 transition-colors duration-300">
          Beranda
        </a>
      </li>

      <li class="relative group">
        <a href="/products" class="nav-link relative font-semibold block py-2 px-2 text-gray-700 transition-colors duration-300">
          Produk
          <span class="ml-1 inline-block transform transition-transform duration-300 group-hover:rotate-180">▼</span>
        </a>

        <!-- Dropdown -->
        <ul class="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible translate-y-3 group-hover:translate-y-0 transition-all duration-300 ease-out z-50">
          <li><a href="/premium" class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900 rounded-md transition-colors duration-300">Premium</a></li>
          <li><a href="/interior" class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900 rounded-md transition-colors duration-300">Interior</a></li>
          <li><a href="/eksterior" class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900 rounded-md transition-colors duration-300">Eksterior</a></li>
          <li><a href="/kayubesi" class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900 rounded-md transition-colors duration-300">Kayu & Besi</a></li>
        </ul>
      </li>

      <li>
        <a href="/colors" class="nav-link relative font-semibold block py-2 px-2 text-gray-700 transition-colors duration-300">
          Warna
        </a>
      </li>
      ...
      @guest
      <li>
        <a href="/login" class="nav-link font-semibold block py-2 px-6 border-2 border-blue-900 rounded-lg text-blue-900 hover:border-blue-700 hover:bg-blue-700 hover:text-white transition-all duration-300">
          Masuk
        </a>
      </li>
      <li>
        <a href="/register" class="nav-link font-semibold block py-2 px-6 border-2 rounded-lg bg-blue-900 text-white hover:border-blue-600 hover:bg-white hover:text-blue-900 transition-all duration-300">
          Daftar
        </a>
      </li>
      @endguest
    ...
    <div class="flex flex-wrap items-center gap-[29px] mt-3 md:mt-0">
      ...
      <div class="relative inline-block text-center">
        ...
        <div id="dropdownMenu"
          ...
          <div class="py-1">
            <a href="/profile" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Profile</a>
